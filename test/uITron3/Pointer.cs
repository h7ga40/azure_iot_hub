...
namespace uITron3
{
	public class pointer
	{
		...
		public pointer(pointer src, int offset = 0)
		{
			m_Data = src.m_Data;
			m_Offset = src.m_Offset + offset;
		}

		public pointer(byte[] data, int offset = 0)
		{
			m_Data = data;
			m_Offset = offset;
		}
	...
	{
		public refptr(byte[] src, int offset = 0) : base(src, offset) { }
		public refptr(pointer src, int offset = 0) : base(src, offset) { }
