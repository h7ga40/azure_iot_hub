...
namespace MicroServer.Net.Http.Mvc
{
	...
	public abstract class Controller : IController
	{
		...
		/// </summary>
		public string ActionName => _context.ActionName;
		...
		/// </remarks>
		public string ControllerUri => _context.ControllerUri;
		...
		/// Can be "controllerName" or "section/controllerName" depending on the <see cref="ControllerUriAttribute"/>.
		/// </remarks>
		public string ControllerName => _context.ControllerUri.TrimStart('/').TrimEnd('/');

		/// <summary>
		/// Gets HTTP request
		/// </summary>
		public IHttpRequest Request => _context.HttpContext.Request;

		/// <summary>
		/// Gets HTTP response.
		/// </summary>
		public IHttpResponse Response => _context.HttpContext.Response;
		...
		public IParameterCollection Form => _context.HttpContext.Request.Form;
