...
namespace MicroServer.Net.Http.Mvc.ActionResults
{
	...
	public class ViewResult : ActionResult
	{
		...
		public override void ExecuteResult(IControllerContext context)
		{
			...
			var fileNamePath = String.Concat(@"\winfs\",
			...
			using (var sr = new StreamReader(fileContext.FileStream)) {
				var content = new TokenEngine(sr.ReadToEnd(), context.ViewData);
				var body = new MemoryStream(Encoding.UTF8.GetBytes(content.ToString()));
