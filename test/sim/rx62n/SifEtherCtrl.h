...
{
public:
	CSifEtherCtrl(TRX62NEDMACReg *edmacReg, TRX62NETHERCReg *ethercReg,
		int intNo, int devNo);
	virtual ~CSifEtherCtrl();
private:
	TRX62NEDMACReg *m_EdmacReg;
	TRX62NEDMACReg m_EdmacRegInst;
	TRX62NETHERCReg *m_EthercReg;
	TRX62NETHERCReg m_EthercRegInst;
	int m_IntNo;
	int m_DevNo;
	CRITICAL_SECTION m_Lock;
	bool m_SendReq;
	TRX62NEtherCTxDescriper *m_TxDsp;
	unsigned char m_SendBuf[2048];
	int m_SendBufPos;
	TRX62NEtherCRxDescriper *m_RxDsp;
