 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: prc_kernel_impl.h 2049 2020-01-22 10:38:36Z coas-nagasima $
 */
 ...
 *  ならない．
 */
extern void	_start_dispatch( void );
#define _kernel_start_dispatch()	_start_dispatch(); return
 ...
 *  そうでない時にtrueを返す．
 */
extern bool_t exc_sense_context( void *p_excinf );
